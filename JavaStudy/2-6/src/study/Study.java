...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        // その理由をコメントへ記述してください。
        //
        // [ここへ記述]MONTHの実際の各月に対して-1の値で結び付けられ定義されているため。
        //           また、12月を越えたり1月を下回ったとしても年の単位に加算減算されず規格外の値になり得るため。
        ...
        //System.out.println(calendar.add(Calendar.YEAR, 1));
        //System.out.println(calendar.add(Calendar.));
        //System.out.println(calendar.add(Calendar.));
